...
<body>
	<form:form modelAttribute="studentForm" method="post" action="insert"
		...
		<fieldset>
			...
			<!-- Form Name -->
			<legend>Student Pan Card Details</legend>
			...
			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="pid">Pan Number</label>
				<div class="col-md-4">
					<form:input path="panCard.panNumber" id="panNumber" name="panNumber"
